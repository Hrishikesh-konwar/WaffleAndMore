...
export default function WaffleMenu() {
  const menuSections: MenuSection[] = [
    {
      ...
      color: 'emerald',
      items: [
        { name: 'Classic Honey Butter', price: '₹90', pocketPrice: '₹70', description: 'Pure golden perfection' },
        { name: 'Maple Butter Bliss', price: '₹90', pocketPrice: '₹70', description: 'Sweet maple dream' },
        { name: 'Nutty Almondlicious', price: '₹170', pocketPrice: '₹130', description: 'Crunchy almond heaven' },
      ],
    },
    {
      title: 'Club Velvet',
    ...
    },
    {
      ...
      color: 'emerald',
      items: [
        { name: 'Snickallicious', price: '₹170', pocketPrice: '₹150', isBestSeller: true },
        { name: 'The Nutella Tease', price: '₹170', pocketPrice: '₹150', isBestSeller: true },
        { name: 'KitCrack Crunch', price: '₹170', pocketPrice: '₹120' },
        { name: 'Belgian Melt (Milk/Dark)', price: '₹160', pocketPrice: '₹110' },
    ...
    },
    {
      ...
      color: 'emerald',
      items: [
        { name: 'Mango Cheesecake', price: '₹150', pocketPrice: '₹130', isBestSeller: true },
    ...
    },
    {
      ...
      color: 'emerald',
      items: [
        { name: 'Brownie Bliss Sundae', price: '₹130', pocketPrice: '₹100', isBestSeller: true },
    ...
    },
    {
      ...
      color: 'amber',
      items: [
        { name: 'Crunchy Almond Brownie Cake', price: '₹590', pocketPrice: '₹380' },
        { name: "Kiki's Crunch Party Cake", price: '₹590', pocketPrice: '₹380', isBestSeller: true },
    ...
    },
    {
      ...
      color: 'emerald',
      items: [
        { name: 'Rocky Road Riot (RRR)', price: '₹190', pocketPrice: '₹150', isBestSeller: true },
  ...
  return (
    <div className="min-h-screen bg-gray-900">
      ...
      {/* Hero Section */}
      <div className="relative overflow-hidden bg-gray-900 text-white py-20 px-4 border-b border-gray-800">
      ...
      <div className="max-w-6xl mx-auto px-4 py-12 bg-gray-900">
        ...
        <div className="mb-16">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-amber-400 to-amber-500 p-8 text-white shadow-xl hover:shadow-2xl transition-all">
              ...
              <h3 className="text-3xl font-bold mb-4 relative z-10">Happy Hours</h3>
              <p className="text-lg font-semibold mb-6 relative z-10">12:00 PM - 5:00 PM</p>
            ...
            <div className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-primary to-emerald-600 p-8 text-white shadow-xl hover:shadow-2xl transition-all">
              <div className="absolute top-0 right-0 w-32 h-32 bg-white/10 rounded-full -mr-16 -mt-16"></div>
              <h3 className="text-3xl font-bold mb-3 relative z-10">Family Combo</h3>
              <p className="text-base font-semibold text-emerald-50 mb-4 relative z-10">Buy 4 & Get 1 Free</p>
              <p className="text-4xl font-black mb-2 relative z-10">₹699</p>
              <div className="space-y-2 relative z-10">
                <p className="text-sm text-emerald-100">Save up to ₹201</p>
                <p className="text-xs text-emerald-100 italic">Friends, family and waffles — that&apos;s a celebration</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          {menuSections.map((section, idx) => {
            ...
            return (
              <div key={idx} className="overflow-hidden rounded-xl shadow-xl hover:shadow-2xl transition-shadow bg-gray-800 border border-gray-700">
                {/* Section Header */}
                <div className={`${colors.header} text-white px-6 py-5 font-bold text-xl`}>
                  {section.title}
                </div>
