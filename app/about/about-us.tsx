        ...
        <div className="max-w-6xl mx-auto px-4 py-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-8">
                ...
                <div className="space-y-6">
                  {[
                    {
                      step: "01",
                      title: "Belgian Inspiration",
                      desc: "Inspired by Belgian craftsmanship and waffle traditions",
                    },
                    {
                      step: "02",
                      title: "Local Roots",
                      desc: "Rooted deep in Bharuch's heart and community",
                    },
                    {
                      step: "03",
                      title: "Thoughtful Creation",
                      desc: "Thoughtfully made with intention and care",
                    },
                    {
                      step: "04",
                      title: "Freshly Served",
                      desc: "Freshly served with every order",
                    },
                    {
                      step: "05",
                      title: "Deeply Felt",
                      desc: "Deeply felt in every bite and interaction",
                    },
                  ].map((item, idx) => (
              ...
              <div className="relative h-full">
                <div className="sticky top-8 bg-gradient-to-br from-primary to-emerald-700 rounded-3xl p-10 text-white shadow-2xl border border-primary">
                  <div className="absolute top-0 right-0 text-8xl opacity-10 font-black">
                    ✕
                  </div>
                  <div className="relative z-10">
                    <h3 className="text-3xl font-black mb-6">Why We Exist</h3>
                    <p className="text-emerald-50 leading-relaxed text-lg mb-6">
                      We believe that food is more than sustenance—it's a
                      conversation between hands and hearts.
                    </p>
                    <p className="text-emerald-50 leading-relaxed text-lg mb-6">
                      Every waffle we craft is an experiment in joy, a moment of
                      pause in a busy world, and a gesture of warmth from our
                      kitchen to your table.
                    </p>
                    <p className="text-emerald-100 italic">
                      We don't just serve waffles. We create memories, one bite
                      at a time.
                    </p>
                  </div>
                </div>
          ...
          <section className="py-16 rounded-3xl bg-gray-800/50 px-8 md:px-12 border border-gray-700">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                {
                  title: "Quality",
                  desc: "Belgian-inspired craftsmanship in every bite",
                },
                {
                  title: "Authenticity",
                  desc: "Local flavors with global appeal",
                },
                {
                  title: "Innovation",
                  desc: "Experimenting with new flavors and experiences",
                },
                {
                  title: "Connection",
                  desc: "Building warmth through every interaction",
                },
              ].map((value, idx) => (
          ...
          <section className="text-center py-16">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
              Visit us today and taste why Waffles & More is more than just a
              cafe—it's a destination.
            </p>
            <Link href="/contact">
