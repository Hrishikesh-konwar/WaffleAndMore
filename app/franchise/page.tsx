              ...
              {[
                {
                  ...
                  desc: "Established brand with successful locations across Gujarat",
                },
                {
                  title: "Comprehensive Support",
                  desc: "Training, marketing, and operational support from day one",
                },
                {
                  title: "Premium Products",
                  desc: "Access to our exclusive recipes and premium ingredients",
                },
                {
                  title: "Growing Market",
                  desc: "Tap into the rapidly growing dessert & waffle market",
                },
                {
                  title: "Strong Brand",
                  desc: "Recognized brand with loyal customer base",
                },
                {
                  title: "Low Investment",
                  desc: "Affordable franchise investment with good ROI potential",
                },
              ].map((item, idx) => (
                <div
                  key={idx}
                  className="border border-gray-700 bg-gray-800 rounded-lg p-8 hover:border-primary/50 transition"
                >
          ...
          <section className="py-20 px-4 sm:px-6 lg:px-8 bg-primary border-t border-gray-800 -mx-4 rounded-2xl">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-lg text-white/90 mb-8">
                Get in touch with our franchise team to discuss opportunities in
                your area.
              </p>
              <Link href="/contact">
                <Button
                  size="lg"
                  className="bg-white text-primary hover:bg-gray-100 font-semibold uppercase tracking-wide"
                >
